...
const  TopPlay = () => {
 ...
 return(
  <div ref={divRef} className="xl:ml-6 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full
  flex flex-col ">
      ...
      <p className="text-gray-300 text-base cursor-pointer">See more</p>
        ...
        <div className="mt-4 flex flex-col gap-1">
          {topPlays?.map((song,i)=>(<TopChartCard  
           song={song} i={i} key={song.key} isPlaying={isPlaying} activeSong={activeSong} handlePauseClick={handlePauseClick}
    ...
    <Link to = "/top-artists">
      <p className="text-gray-300 text-base cursor-pointer">See more</p>
        ...
        <Swiper slidesPerView="auto" spaceBetween={15} freeMode centeredSlides modules={[FreeMode]} className="mt-4">
            {topPlays?.map((song,i) => (
              <SwiperSlide
              key={song?.key}
